...
class TicksM {
  ...
  void paint(PaintingContext context, Offset offset, double translation,
      double scale, double height, TimelineM timelineM) {
    ...
    double gutterWidth = timelineM.gutterWidth;
    ...
    double s =
    timelineM.computeScale(timelineM.renderStart, timelineM.renderEnd);

    /// y-coordinate for the starting and ending element.
    double y1 = timelineM.renderStart * s;
    double y2 = timelineM.renderStart * s;
    ...
    for (int i = 0; i < numTicks; i++) {
      ...
      TickColorsM? colors = timelineM.findTickColorsM(offset.dy + height - o);
