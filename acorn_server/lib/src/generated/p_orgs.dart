...
class PrincipalOrgsUpdateTable extends _i1.UpdateTable<PrincipalOrgsTable> {
  PrincipalOrgsUpdateTable(super.table);
  ...
  _i1.ColumnValue<int, int> orgId(int value) => _i1.ColumnValue(
    table.orgId,
    value,
  );
}
...
class PrincipalOrgsTable extends _i1.Table<int?> {
  PrincipalOrgsTable({super.tableRelation})
    ...
    updateTable = PrincipalOrgsUpdateTable(this);
  ...
  late final PrincipalOrgsUpdateTable updateTable;
...
class PrincipalOrgsRepository {
  ...
  /// Updates a single [PrincipalOrgs] by its [id] with the specified [columnValues].
  /// Returns the updated row or null if no row with the given id exists.
  Future<PrincipalOrgs?> updateById(
    _i1.Session session,
    int id, {
    required _i1.ColumnValueListBuilder<PrincipalOrgsUpdateTable> columnValues,
    _i1.Transaction? transaction,
  }) async {
    return session.db.updateById<PrincipalOrgs>(
      id,
      columnValues: columnValues(PrincipalOrgs.t.updateTable),
      transaction: transaction,
    );
  }

  /// Updates all [PrincipalOrgs]s matching the [where] expression with the specified [columnValues].
  /// Returns the list of updated rows.
  Future<List<PrincipalOrgs>> updateWhere(
    _i1.Session session, {
    required _i1.ColumnValueListBuilder<PrincipalOrgsUpdateTable> columnValues,
    ...
    return session.db.updateWhere<PrincipalOrgs>(
      columnValues: columnValues(PrincipalOrgs.t.updateTable),
