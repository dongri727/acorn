...
import 'package:acorn_client/src/protocol/att_involved.dart' as _i25;
import 'package:acorn_client/src/protocol/c_involved.dart' as _i26;
import 'package:acorn_client/src/protocol/categories.dart' as _i27;
import 'package:acorn_client/src/protocol/countryatts.dart' as _i28;
import 'package:acorn_client/src/protocol/lieux.dart' as _i29;
import 'package:acorn_client/src/protocol/localdates.dart' as _i30;
import 'package:acorn_client/src/protocol/organisations.dart' as _i31;
import 'package:acorn_client/src/protocol/p_categories.dart' as _i32;
import 'package:acorn_client/src/protocol/p_catt.dart' as _i33;
import 'package:acorn_client/src/protocol/p_orgs.dart' as _i34;
import 'package:acorn_client/src/protocol/p_patt.dart' as _i35;
import 'package:acorn_client/src/protocol/p_people.dart' as _i36;
import 'package:acorn_client/src/protocol/p_seas.dart' as _i37;
import 'package:acorn_client/src/protocol/p_terms.dart' as _i38;
import 'package:acorn_client/src/protocol/pays.dart' as _i39;
import 'package:acorn_client/src/protocol/people.dart' as _i40;
import 'package:acorn_client/src/protocol/placeatts.dart' as _i41;
import 'package:acorn_client/src/protocol/places.dart' as _i42;
import 'package:acorn_client/src/protocol/principal.dart' as _i43;
import 'package:acorn_client/src/protocol/seas.dart' as _i44;
import 'package:acorn_client/src/protocol/terms.dart' as _i45;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == List<_i25.AttsInvolved>) {
      return (data as List)
          .map((e) => deserialize<_i25.AttsInvolved>(e))
          .toList() as dynamic;
    }
    if (t == List<_i26.CountryInvolved>) {
      return (data as List)
          .map((e) => deserialize<_i26.CountryInvolved>(e))
          .toList() as dynamic;
    }
    if (t == List<_i27.Categories>) {
      return (data as List).map((e) => deserialize<_i27.Categories>(e)).toList()
          as dynamic;
    }
    if (t == List<_i28.Countryatts>) {
      return (data as List)
          .map((e) => deserialize<_i28.Countryatts>(e))
          .toList() as dynamic;
    }
    if (t == List<_i29.Lieux>) {
      return (data as List).map((e) => deserialize<_i29.Lieux>(e)).toList()
          as dynamic;
    }
    if (t == List<_i30.LocalDates>) {
      return (data as List).map((e) => deserialize<_i30.LocalDates>(e)).toList()
          as dynamic;
    }
    ...
    if (t == List<_i32.PrincipalCategories>) {
      return (data as List)
          .map((e) => deserialize<_i32.PrincipalCategories>(e))
          .toList() as dynamic;
    }
    if (t == List<_i33.PrincipalCatt>) {
      return (data as List)
          .map((e) => deserialize<_i33.PrincipalCatt>(e))
          .toList() as dynamic;
    }
    if (t == List<_i34.PrincipalOrgs>) {
      return (data as List)
          .map((e) => deserialize<_i34.PrincipalOrgs>(e))
          .toList() as dynamic;
    }
    if (t == List<_i35.PrincipalPatt>) {
      return (data as List)
          .map((e) => deserialize<_i35.PrincipalPatt>(e))
          .toList() as dynamic;
    }
    if (t == List<_i36.PrincipalPeople>) {
      return (data as List)
          .map((e) => deserialize<_i36.PrincipalPeople>(e))
          .toList() as dynamic;
    }
    ...
    if (t == List<_i37.PrincipalSeas>) {
      return (data as List)
          .map((e) => deserialize<_i37.PrincipalSeas>(e))
          .toList() as dynamic;
    }
    if (t == List<_i38.PrincipalTerms>) {
      return (data as List)
          .map((e) => deserialize<_i38.PrincipalTerms>(e))
          .toList() as dynamic;
    }
    if (t == List<_i39.Pays>) {
      return (data as List).map((e) => deserialize<_i39.Pays>(e)).toList()
          as dynamic;
    }
    if (t == List<_i40.People>) {
      return (data as List).map((e) => deserialize<_i40.People>(e)).toList()
          as dynamic;
    }
    if (t == List<_i41.Placeatts>) {
      return (data as List).map((e) => deserialize<_i41.Placeatts>(e)).toList()
          as dynamic;
    }
    ...
    if (t == List<_i43.Principal>) {
      return (data as List).map((e) => deserialize<_i43.Principal>(e)).toList()
          as dynamic;
    }
    ...
    if (t == List<_i44.Seas>) {
      return (data as List).map((e) => deserialize<_i44.Seas>(e)).toList()
          as dynamic;
    }
